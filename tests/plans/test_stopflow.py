...
SEQ_TABLE_TEST_CASES: tuple[tuple[SeqTable, SeqTable], ...] = (
    ...
    (
        ...
        ),
        {
            ...
            "time1": np.array([0, 50000, 0, 0, 0], dtype=np.uint32),
            "outa1": np.array([False, True, False, False, False]),
    ...
    (
        ...
        ),
        {
            ...
            "time2": np.array([4000, 2280, 4000, 4000], dtype=np.uint32),
            "outa2": np.array([True, True, False, False]),
